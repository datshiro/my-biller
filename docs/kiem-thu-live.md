...
điểm vào để tìm coverage. Riêng `hai-may.robot` có 17 ca chạy hai Browser Context cùng trỏ vào một
...
│   └── hai-may.robot         17 ca · đồng bộ, rollback, thu hồi, resync, lease/epoch, đối soát
└── results/
